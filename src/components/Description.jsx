    ...
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
          ...
          <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. Whether you need stunning visuals or unique imagery, our tool transform your text into eye-chatching images with just a few clicks. Imagine it, describe it, and watch it come to life instantly.</p>
